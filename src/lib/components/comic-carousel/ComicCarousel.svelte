<!-- src/lib/components/comic-carousel/ComicCarouselItem.svelte -->
<script lang="ts">
				...
				<Card.CardContent class="relative flex h-[400px] p-0">
					...
					<div class="relative z-10 flex w-full gap-4 p-8 text-white">
						<div class="flex-1 space-y-4">
							<div>
								<h2 class="text-2xl font-semibold transition-colors hover:text-primary">
								...
								<Badge variant="default" class="mt-2">{comic.type}</Badge>
